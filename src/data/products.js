...
export const products = [
  {
    ...
    categorias: ["perfumes-masculinos", "amadeirado", "presentes", "mais-vendidos", "noite", "o-boticario"],
...

  {
    ...
    marca: "LANCÔME",
    descricao: "Perfume feminino floral gourmand, doce e elegante, com assinatura de íris, patchouli e baunilha.",
    tamanho: "100ml",
    preco: 629.99,
    imagem: floral,

    categorias: ["perfumes-femininos", "floral", "adocicado", "presentes", "luxo", "mais-vendidos", "lancome"],
...

  {
    ...
    marca: "CHANSON D'EAU",
    descricao: "Perfume feminino doce e gourmand, com destaque para baunilha e âmbar, trazendo sensação confortável e envolvente.",
    tamanho: "100ml",
    preco: 119.90,
    imagem: vanilla,

    categorias: ["perfumes-femininos", "adocicado", "presentes", "dia-a-dia", "chanson-d-eau"],
...

  {
    ...
    categorias: ["perfumes-femininos", "adocicado", "dia-a-dia", "presentes", "victorias-secret"],
...

  {
    ...
    categorias: ["perfumes-masculinos", "amadeirado", "luxo", "mais-vendidos", "dior"],
...

  {
    ...
    categorias: ["perfumes-masculinos", "citrico", "dia-a-dia", "davidoff"],
...

  {
    ...
    categorias: ["perfumes-femininos", "floral", "luxo", "gucci"],
...

  {
    ...
    categorias: ["perfumes-femininos", "oriental", "luxo", "chloe"],
    familia: "Oriental",
    genero: "Feminino",
    intensidade: "intensa",
    ocasioes: ["noite"],
...

  {
    ...
    categorias: ["perfumes-femininos", "adocicado", "luxo", "asdaaf"],
...

  {
    ...
    categorias: ["perfumes-femininos", "floral", "mais-vendidos", "eudora"],
...

  {
    ...
    categorias: ["perfumes-masculinos", "amadeirado", "dia-a-dia", "eudora"],
    familia: "Amadeirado",
    genero: "Masculino",
    intensidade: "moderada",
